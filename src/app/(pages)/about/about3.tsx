    ...
    return(
        <div id="about_4" className="sm:absolute sm:top-0 ">
            <div className="md:space-y-5 sm:space-y-5 space-y-4 sm:pl-20 pl-5">
               ...
               <p className="md:text-lg md:font-extralight sm:text-lg sm:font-extralight text-lg font-extralight relative  w-96 overflow-hidden">I've been lucky enough to have my work featured in books, magazines and websites around the world. I've also spoken at various design events and enjoy sharing my love of design on social media.</p>
